...
export default function OptimizeCloudOperations() {
  ...
  return (
    <main className="min-h-screen page-bg-light overflow-x-hidden" onMouseMove={handleMouseMove}>
      <SEO
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            <div className="flex-1 text-center lg:text-left">
              ...
              >
                Enhance Your Cloud Strategy. Simplify Management and Maximize ROI. Transform your infrastructure from a
                complex burden into a scalable asset.
              </motion.p>
              <motion.div
                {...fadeIn}
                transition={{
            ...
            <motion.div {...fadeIn}>
              ...
              <div className="space-y-6 text-slate-600 leading-relaxed text-lg">
                <p>
                  ...
                  proper optimization, businesses face{" "}
                  <span className="text-slate-900 font-semibold underline decoration-primary/30 decoration-2 underline-offset-4">
                    "cloud sprawl"
                  </span>
                  —uncontrolled costs, security gaps, and administrative complexity.
                </p>
                <p>
                  At Enhance Tech, we help you tame the complexity. We provide the expertise to streamline your
                  Microsoft environment, automate tedious tasks, and ensure you are only paying for the resources you
                  actually use.
                </p>
              </div>
            </motion.div>
      ...
      <section className="py-24 bg-slate-50 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <motion.h2
              {...fadeIn}
              className="text-3xl md:text-4xl font-bold mb-4 tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-cyan-300 to-blue-500"
            >
              Key Benefits
            </motion.h2>
            ...
            {[
              {
                ...
                desc: "Identify and remove unused licenses and 'zombie' servers to reduce cloud spend instantly.",
              },
              {
                icon: Layout,
                title: "Streamlined Administration",
                desc: "Control all your devices and users from a single unified cloud dashboard.",
              },
              {
                icon: Zap,
                title: "Seamless Scalability",
                desc: "Scale your server power up or down instantly based on your real-time business demand.",
              },
              {
                icon: Lock,
                title: "Automated Governance",
                desc: "Enforce security policies automatically (e.g., 'Block logins from outside the UAE').",
              },
              {
                icon: Eye,
                title: "Enhanced Visibility",
                desc: "See exactly who is doing what across your entire cloud environment with detailed auditing.",
              },
              {
                icon: Laptop,
                title: "Zero-Touch Deployment",
                desc: "Set up new employee laptops automatically over Wi-Fi without any IT intervention.",
              },
            ].map((benefit, i) => (
              <motion.div
                key={i}
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-xl font-bold text-slate-900 mb-4 group-hover:text-primary transition-colors tracking-tight">
                    {benefit.title}
                  </h3>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <motion.h2
              {...fadeIn}
              className="text-3xl md:text-5xl font-bold mb-4 tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-cyan-300 to-blue-500"
            >
              Our Tech Ecosystem
            </motion.h2>
            <motion.p {...fadeIn} className="text-slate-600 max-w-2xl mx-auto text-lg leading-relaxed">
                      ...
                      {[
                        {
                          ...
                          desc: "Deliver a secure Windows experience to any device, anywhere.",
                        },
                        {
                          title: "Server Migration",
                          desc: "Retire aging hardware. We migrate SQL and DCs with zero data loss.",
                        },
                        {
                          title: "Cost Optimization",
                          desc: "Active monitoring ensures you never overpay for idle resources.",
                        },
                      ].map((item, idx) => (
                        <motion.div
                          key={idx}
                        ...
                        >
                          ...
                          <div>
                            <h4 className="font-bold text-white mb-1.5 text-lg group-hover/item:text-cyan-300 transition-colors">
                              {item.title}
                            </h4>
              ...
              >
                <div className="space-y-4">
                  ...
                  <p className="text-lg leading-relaxed">
                    We help you move your heavy on-premise servers into the agile world of Azure. Whether you are
                    lifting and shifting legacy applications or building modern cloud-native apps, we ensure your
                    infrastructure is optimized for performance and cost.
                  </p>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-slate-50 p-6 rounded-3xl border border-slate-100 font-bold text-sm text-center text-primary shadow-sm hover:bg-white hover:border-primary/20 transition-all uppercase tracking-widest">
                    FinOps Ready
                  </div>
                  <div className="bg-slate-50 p-6 rounded-3xl border border-slate-100 font-bold text-sm text-center text-primary shadow-sm hover:bg-white hover:border-primary/20 transition-all uppercase tracking-widest">
                    Cloud-Native
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="relative bg-slate-900 p-12 rounded-[48px] border border-white/5 overflow-hidden group shadow-2xl">
                  ...
                  <div className="relative z-10 text-white">
                    <div className="px-4 py-1.5 bg-sky-500/10 border border-sky-500/20 rounded-full inline-block mb-6">
                      <span className="text-sky-400 font-bold tracking-[0.3em] uppercase text-[10px]">
                        Productivity
                      </span>
                    </div>
                      ...
                      {[
                        {
                          ...
                          desc: "Architected for discoverability, security, and automated backups.",
                        },
                        {
                          title: "License Management",
                          desc: "Active analysis ensures you aren't paying for features you don't use.",
                        },
                        {
                          title: "Identity Security",
                          desc: "SSO and MFA configuration to secure user identities flawlessly.",
                        },
                      ].map((item, idx) => (
                        <motion.div
                          key={idx}
                        ...
                        >
                          ...
                          <div>
                            <h4 className="font-bold text-white mb-1.5 text-lg group-hover/item:text-sky-300 transition-colors">
                              {item.title}
                            </h4>
                            <p className="text-slate-400 text-sm leading-relaxed">{item.desc}</p>
                          </div>
              ...
              >
                <div className="space-y-4">
                  ...
                  <p className="text-lg leading-relaxed">
                    Most businesses use less than 20% of the Microsoft 365 features they pay for. We help you unlock the
                    full value of your subscription, turning it from just "Email" into a complete operating system for
                    your business.
                  </p>
                </div>
                <div className="grid grid-cols-2 gap-4">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="relative bg-slate-900 p-12 rounded-[48px] border border-white/5 overflow-hidden group shadow-2xl">
                  ...
                  <div className="relative z-10 text-white">
                    <div className="px-4 py-1.5 bg-indigo-500/10 border border-indigo-500/20 rounded-full inline-block mb-6">
                      <span className="text-indigo-400 font-bold tracking-[0.3em] uppercase text-[10px]">
                        Fleet Management
                      </span>
                    </div>
                      ...
                      {[
                        {
                          ...
                          desc: "New laptops install company settings automatically upon first boot.",
                        },
                        {
                          title: "Mobile Management",
                          desc: "Secure company data on employee phones with selective wiping.",
                        },
                        {
                          title: "Patch Compliance",
                          desc: "Automatic fleet-wide updates close security loops without friction.",
                        },
                      ].map((item, idx) => (
                        <motion.div
                          key={idx}
                        ...
                        >
                          ...
                          <div>
                            <h4 className="font-bold text-white mb-1.5 text-lg group-hover/item:text-indigo-300 transition-colors">
                              {item.title}
                            </h4>
                            <p className="text-slate-400 text-sm leading-relaxed">{item.desc}</p>
                          </div>
              ...
              >
                <div className="space-y-4">
                  ...
                  <p className="text-lg leading-relaxed">
                    The days of manually installing software on every computer are over. We use Microsoft Intune to
                    manage your devices purely from the cloud, ensuring consistency, security, and ease of deployment.
                  </p>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-slate-50 p-6 rounded-3xl border border-slate-100 font-bold text-sm text-center text-primary shadow-sm hover:bg-white hover:border-primary/20 transition-all uppercase tracking-widest">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col lg:flex-row gap-20 items-center">
            <div className="lg:w-1/3">
              <motion.div
                {...fadeIn}
                className="inline-flex items-center gap-2 px-4 py-1.5 bg-cyan-500/10 rounded-full mb-6 border border-cyan-500/20"
              >
              ...
              <motion.h2
                {...fadeIn}
                className="text-3xl md:text-5xl font-extrabold mb-8 leading-tight tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-cyan-300 to-blue-500"
              >
                We Don't Just Setup. <br /> We Fine-Tune.
              </motion.h2>
              <motion.p {...fadeIn} className="text-slate-400 text-lg leading-relaxed">
                A cloud environment is a living thing—it grows and changes every day. Enhance Tech provides ongoing
                optimization to ensure it stays efficient, secure and scalable.
              </motion.p>
            </div>
              ...
              {[
                {
                  ...
                  desc: "We review your security score and usage trends to recommend configuration improvements.",
                },
                {
                  title: "FinOps (Cost Analysis)",
                  desc: "We provide detailed reports on your cloud spend to prevent budget 'bill shock'.",
                },
                {
                  title: "Migration Project Management",
                  desc: "From Google Workspace or on-premise Exchange, we handle all data heavy lifting.",
                },
                {
                  title: "Continuous Optimization",
                  desc: "Ongoing tuning of your environment to match evolving business needs.",
                },
              ].map((item, i) => (
                <motion.div
                  key={i}
                ...
                >
                  ...
                  <h3 className="text-xl font-bold mb-4 group-hover:text-cyan-300 transition-colors uppercase tracking-tight">
                    {item.title}
                  </h3>
      ...
      <section className="py-24 bg-white relative">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.h2
            {...fadeIn}
            className="text-3xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-cyan-300 to-blue-500"
          >
