...
export default function OptimizeCloudOperations() {
  ...
  return <main className="min-h-screen page-bg-light overflow-x-hidden" onMouseMove={handleMouseMove}>
            <SEO title="Optimize Cloud Operations: Azure & Microsoft 365 | Enhance Tech" description="Maximize your Microsoft Cloud ROI with Enhance Tech. Optimize Azure infrastructure, streamline Microsoft 365 management, and control cloud costs." keywords="Cloud Operations, Azure Management, Microsoft 365 Optimization, Cloud Cost Control, FinOps, Dubai IT Solutions" canonicalUrl="https://itenhance.tech/solutions/optimize-cloud-operations" />
        ...
        ease: "easeInOut"
              ...
              delay: 0.1,
              duration: 0.8
            }} className="text-4xl md:text-5xl xl:text-7xl font-extrabold text-white mb-6 leading-[1.1] tracking-tight lg:text-5xl">
            ...
            once: true
                            ...
                            <div className="relative rounded-[32px] overflow-hidden shadow-2xl border border-slate-100">
                                <img src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=2072&auto=format&fit=crop" alt="Cloud Computing Visualization" className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-1000" />
          ...
          once: true
            ...
            <section className="py-24 bg-white">
              ...
              once: true
                    ...
                    }].map((item, idx) => <motion.div key={idx} variants={listItemVariants} className="flex gap-5 group/item p-4 -m-4 rounded-2xl hover:bg-white/5 transition-colors cursor-default">
