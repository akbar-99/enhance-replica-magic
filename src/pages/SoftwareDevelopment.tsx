    ...
    <main className="min-h-screen page-bg-light overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden page-section-blue">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-300 to-pink-500 mb-6 animate-fade-up">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-6 text-slate-600 leading-relaxed">
                <p>
                  In a digital-first world, your website and applications are often the first point of contact with your
                  customers. Off-the-shelf software can only take you so far; to truly differentiate your brand, you
                  need technology built specifically for you.
                </p>
                <p>
                  Software & Web Development at Enhance Tech is about more than just code. We design, develop, and
                  deploy custom digital solutions that align perfectly with your business goals.
                </p>
                <p>
                  From stunning corporate websites to complex mobile apps and internal automation tools, we build the
          ...
          <div className="space-y-32">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                <h3 className="text-2xl font-bold text-slate-900 mb-2"> Custom Web Development</h3>
                <p className="text-lg font-medium text-indigo-600 mb-6">"Responsive, Fast, and SEO-Ready"</p>
                <p className="text-slate-600 mb-8">
                  Your website is your 24/7 digital storefront. We build high-performance websites that look great on
                  every device and convert visitors into customers.
                </p>
                ...
                <Accordion type="single" collapsible className="w-full space-y-4">
                  ...
                  >
                    <AccordionTrigger className="text-slate-900 hover:text-indigo-600 hover:no-underline font-semibold text-left">
                      Corporate Websites
                    </AccordionTrigger>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="order-2 lg:order-1">
                ...
                <h3 className="text-2xl font-bold text-slate-900 mb-2"> Mobile App Development</h3>
                <p className="text-lg font-medium text-pink-600 mb-6">"Engage Your Audience on the Go"</p>
                <p className="text-slate-600 mb-8">
                  Put your business in the palm of your customer’s hand. We develop native and hybrid mobile
                  applications that deliver seamless user experiences across all platforms.
                </p>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                <h3 className="text-2xl font-bold text-slate-900 mb-2"> Custom Software & API Integration</h3>
                <p className="text-lg font-medium text-blue-600 mb-6">"Solving Unique Business Challenges"</p>
                <p className="text-slate-600 mb-8">
                  When standard software doesn't fit, we build what you need. We also connect your existing systems so
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="order-2 lg:order-1">
                ...
                <h3 className="text-2xl font-bold text-slate-900 mb-2"> UI/UX Design</h3>
                <p className="text-lg font-medium text-teal-600 mb-6">"Designed for Users, Built for Business"</p>
                <p className="text-slate-600 mb-8">
                  Great software must be easy to use. Our design team focuses on User Experience (UX) and User Interface
                  (UI) to ensure your digital products are intuitive and engaging.
                </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-16 text-center">
            <div className="p-6 bg-slate-800/50 rounded-lg">
              ...
              <p className="text-slate-400 text-sm">
                We listen to your goals, analyze competitors, and define technical requirements.
              </p>
            </div>
            <div className="p-6 bg-slate-800/50 rounded-lg">
              <h4 className="font-bold text-white mb-2">Development & Testing</h4>
              <p className="text-slate-400 text-sm">
                Clean, scalable code. Rigorous testing for security and mobile responsiveness.
              </p>
            </div>
            <div className="p-6 bg-slate-800/50 rounded-lg">
              <h4 className="font-bold text-white mb-2">Launch & Support</h4>
              <p className="text-slate-400 text-sm">
                Deployment handling and continuous maintenance to keep software running.
              </p>
            </div>
          </div>
        </div>
            ...
            {[
              {
                ...
                desc: "Apps that are secure by design, protecting data from the start.",
              },
      ...
      <section className="py-24 bg-gradient-to-r from-indigo-600 to-pink-600 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 text-white">
          ...
          <p className="text-lg text-indigo-100 mb-10">Let’s create digital experiences that drive results.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/contact">
              <Button
                size="lg"
                variant="secondary"
                className="w-full sm:w-auto text-indigo-600 font-bold hover:bg-white"
              >
                Start Your Project Today
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
