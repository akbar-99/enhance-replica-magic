            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              >
                <Link to="/contact">
                  <Button
                    size="lg"
                    className="bg-purple-600 hover:bg-purple-500 text-white shadow-[0_0_30px_-5px_rgba(147,51,234,0.4)] rounded-full px-12 h-20 text-xl font-black transition-all hover:scale-105 active:scale-95 group"
                  >
      ...
      <section className="py-24 bg-slate-50 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <motion.div
              {...fadeIn}
              className="inline-flex items-center gap-2 px-4 py-1.5 bg-purple-500/10 rounded-full mb-4 border border-purple-500/20"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-20 items-center">
            <div className="lg:w-1/3">
              <motion.div
                {...fadeIn}
                className="inline-flex items-center gap-2 px-4 py-1.5 bg-purple-100 rounded-full mb-6 border border-purple-200"
              >
