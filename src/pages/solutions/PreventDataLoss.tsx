          ...
          <div className="space-y-32">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              once: true
                ...
                <img src="https://images.unsplash.com/photo-1544197150-b99a580bb7a8?q=60&w=1200&auto=format&fit=crop" alt="Acronis Backup Solutions" className="rounded-[32px] shadow-2xl border border-white/5" loading="lazy" />
              </motion.div>
            </div>
