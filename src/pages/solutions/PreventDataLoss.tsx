        ...
        <div className="space-y-32">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div initial={{
              ...
              <img src="/lovable-uploads/acronis-dashboard.webp" alt="Acronis Cyber Protect Cloud Dashboard" className="rounded-[32px] shadow-2xl border border-white/5 w-full object-contain" loading="lazy" />
            </motion.div>
          </div>
