        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          <div className="flex-1 text-center lg:text-left">
            ...
            <motion.p {...fadeIn} transition={{
              ...
              Enhance Your Data Strategy. <span className="text-white font-bold">Protect, Backup, and Control</span>{" "}
            ...
            <motion.div {...fadeIn} transition={{
              ...
              <Link to="/contact">
                <Button size="lg" className="bg-gradient-to-r from-purple-500 to-indigo-700 hover:from-purple-400 hover:to-indigo-600 text-white shadow-xl shadow-purple-500/25 rounded-2xl px-10 h-14 text-base font-bold transition-all hover:scale-105 active:scale-95 border-none">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <motion.div {...fadeIn}>
            ...
            <div className="space-y-6 text-slate-600 leading-relaxed text-lg">
              <p className="font-semibold text-slate-900">Data is your organization's most valuable asset.</p>
              <p>
                But protecting it requires a dual approach: ensuring you can recover it if systems fail, and ensuring
                it doesn't leak to unauthorized recipients.
              </p>
              <p>
                At Enhance Tech, we provide a holistic Data Loss Prevention (DLP) strategy. We combine robust backup
                solutions with advanced data governance to ensure your information is safe, compliant, and under
                control.
              </p>
            </div>
          </motion.div>
          <motion.div initial={{
            ...
            <div className="relative rounded-[32px] overflow-hidden shadow-2xl border border-slate-100">
              <img src="https://images.unsplash.com/photo-1558494949-ef010cbdcc31?q=60&w=1200&auto=format&fit=crop" alt="Data Protection Technology" className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-1000" loading="lazy" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <motion.div {...fadeIn} className="inline-flex items-center gap-2 px-4 py-1.5 bg-purple-500/10 rounded-full mb-4 border border-purple-500/20">
            ...
            <span className="text-xs font-extrabold text-purple-600 uppercase tracking-[0.2em]">
              Strategic Benefits
            </span>
          </motion.div>
        ...
        <motion.div variants={staggerContainer} initial="initial" whileInView="whileInView" viewport={{
          ...
          {[{
            icon: RefreshCw,
            title: "Instant Business Continuity",
            desc: "Reduce downtime from days to minutes."
          }, {
            icon: Search,
            title: "Proactive Data Governance",
            desc: "Know exactly where your sensitive data lives and who is accessing it."
          }, {
            icon: AlertTriangle,
            title: "Prevent Accidental Leaks",
            desc: "Stop employees from sending sensitive files to personal emails or external drives."
          }, {
            icon: ShieldCheck,
            title: "Ransomware Immunity",
            desc: "Restore clean copies of data without paying ransoms."
          }, {
            icon: FileText,
            title: "Regulatory Compliance",
            desc: "Meet strict standards (GDPR, ISO, Regional Data Laws) with automated labeling."
          }, {
            icon: Globe,
            title: "Protection for Any Workload",
            desc: "Cover physical servers, cloud apps, and sensitive documents."
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-2xl font-black text-slate-900 mb-6 group-hover:text-purple-600 transition-colors tracking-tight leading-tight">
                {benefit.title}
              </h3>
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          <motion.div initial={{
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {["Cloud & On-Premise Backup", "Microsoft 365 Data Loss Prevention (DLP)", "Information Protection & Sensitivity Labeling", "Disaster Recovery as a Service (DRaaS)", "Email Archiving & eDiscovery", "Insider Risk Management"].map((item, idx) => <motion.div key={idx} initial={{
                opacity: 0,
                y: 10
              }} whileInView={{
                opacity: 1,
                ...
                <span className="text-slate-700 font-semibold text-sm group-hover:text-purple-700 transition-colors">
                  {item}
                </span>
              </motion.div>)}
            </div>
          ...
          <motion.div initial={{
            ...
            <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=60&w=1200&auto=format&fit=crop" alt="Data Analytics Dashboard" className="rounded-[38px] opacity-80 group-hover:scale-105 transition-transform duration-1000" loading="lazy" />
          </motion.div>
        </div>
      </div>
    </section>
        ...
        <div className="space-y-32">
              ...
              <motion.div whileHover={{
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-slate-300 mb-10 leading-relaxed text-sm">
                    Acronis Cyber Protect is the infrastructure safety net. It protects your core systems—whether
                    physical servers in your office or virtual machines in the cloud.
                  </p>
                  <div className="space-y-6">
                    {[{
                      title: "Universal Restore",
                      desc: "Restore your entire system to completely different hardware or to the cloud."
                    }, {
                      title: "Acronis Active Protection",
                      desc: "AI-based technology that stops ransomware from encrypting your backup files."
                    }, {
                      title: "Instant Boot",
                      desc: "Run your backup as a virtual machine immediately during a crash."
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{
              ...
              <motion.div whileHover={{
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-slate-300 mb-10 leading-relaxed text-sm">
                    Microsoft ensures the infrastructure works, but your data is your responsibility. Dropsuite
                    protects your cloud data from accidental deletion and corruption.
                  </p>
                  <div className="space-y-6">
                    {[{
                      title: "Automated Backup",
                      desc: "Continuous backup of Emails, OneDrive, and SharePoint files multiple times a day."
                    }, {
                      title: "1-Click Restore",
                      desc: "Restore accidentally deleted folders instantly with original permissions intact."
                    }, {
                      title: "Email Archiving",
                      desc: "Tamper-proof archiving ready for legal discovery and audits."
            ...
            <motion.div initial={{
              ...
              <img src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=60&w=1200&auto=format&fit=crop" alt="Cloud Backup Solutions" className="rounded-[32px] shadow-2xl border border-white/5" loading="lazy" />
            </motion.div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <motion.div whileHover={{
                ...
                <div className="relative z-10">
                  <div className="px-4 py-1.5 bg-purple-500/20 border border-purple-500/30 rounded-full inline-block mb-6">
                    <span className="text-purple-400 font-bold tracking-[0.3em] uppercase text-[10px]">
                  ...
                  <p className="text-slate-300 mb-10 leading-relaxed text-sm">
                    While Acronis and Dropsuite help you recover data, Microsoft Purview helps you control it. It
                    provides visibility across your entire data estate.
                  </p>
                  <div className="space-y-6">
                    {[{
                      title: "Information Protection",
                      desc: "Automatically classify documents as 'Confidential'—encryption travels with the file."
                    }, {
                      title: "Data Loss Prevention (DLP)",
                      desc: "Prevent sharing of credit card numbers, customer lists, or ID numbers via email."
                    }, {
                      title: "Insider Risk Management",
                      desc: "Detect resigning employees downloading proprietary data before they leave."
                    }, {
                      title: "Compliance Manager",
                      desc: "Simplify your journey to ISO 27001 or GDPR with automated assessments."
                    }].map((item, idx) => <div key={idx} className="flex gap-4 group/item">
                      <div className="w-1 h-auto bg-purple-500/30 rounded-full group-hover/item:bg-purple-500 transition-colors" />
                      <div>
                        <h4 className="font-bold text-white text-base group-hover/item:text-purple-200 transition-colors">
                          {item.title}
                        </h4>
                        <p className="text-slate-400 text-sm">{item.desc}</p>
                      </div>
            ...
            <motion.div initial={{
              ...
              <img src="https://images.unsplash.com/photo-1563986768609-322da13575f3?q=60&w=1200&auto=format&fit=crop" alt="Microsoft Purview Governance" className="rounded-[32px] shadow-2xl border border-white/5" loading="lazy" />
            </motion.div>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row gap-20 items-center">
          <div className="lg:w-1/3">
            ...
            <motion.p {...fadeIn} className="text-slate-600 text-lg leading-relaxed">
              Strategies fail without management. A backup is useless if it doesn't restore, and a DLP policy is
              useless if it blocks legitimate business.
            </motion.p>
          </div>

          <div className="lg:w-2/3 grid md:grid-cols-2 gap-8">
            {[{
              title: "Daily Success Monitoring",
              desc: "We watch your backup dashboards so you don't have to.",
              icon: Activity
            }, {
              title: "Policy Tuning",
              desc: "Configure Purview policies that secure data without frustrating employees.",
              icon: Lock
            }, {
              title: "Recovery Drills",
              desc: "Scheduled test restores to prove your data is recoverable when disaster strikes.",
              icon: RefreshCw
            }, {
              title: "Managed Resilience",
              desc: "At Enhance Secure, we manage the entire process for you.",
              icon: ShieldCheck
              ...
              <h3 className="text-xl font-bold mb-4 group-hover:text-purple-600 transition-colors uppercase tracking-tight">
                {item.title}
              </h3>
