        ...
        <main className="min-h-screen page-bg-light overflow-x-hidden relative">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                        <div className="flex-1 text-center lg:text-left">
                            <motion.div {...fadeIn} className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-md rounded-full mb-6 border border-white/20">
                                ...
                                <span className="text-sm font-semibold text-blue-100 uppercase tracking-wider">360° Business Protection</span>
                            </motion.div>
                            <motion.h1
                                {...fadeIn}
                            ...
                            >
                                Secure Your Endpoints, Email, and Workforce with <span className="text-white font-bold">Enhance Secure</span>. A multi-layered strategy for today's digital landscape.
                            </motion.p>
                            <motion.div
                                {...fadeIn}
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <motion.div {...fadeIn}>
                            ...
                            <div className="space-y-6 text-slate-600 leading-relaxed text-lg">
                                ...
                                <p>
                                    In today’s interconnected digital landscape, cyber threats recognize no borders. From sophisticated ransomware targeting enterprises to automated phishing attacks hitting small businesses, the risk is universal. To truly secure your organization, you need a multi-layered strategy that protects your devices, filters your communication, and monitors internal risks.
                                </p>
                                <p>
                                    At Enhance Tech, we have curated a portfolio of world-class technologies to stop cyber threats before they disrupt your business operations.
                                </p>
                            </div>
                        </motion.div>
                        <motion.div
                    ...
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        ...
                        >
                            ...
                            >
                                <div className="px-4 py-1.5 bg-red-500/10 border border-red-500/20 rounded-full inline-block mb-6">
                                    <span className="text-red-600 font-bold tracking-[0.2em] uppercase text-[10px]">Endpoint Security</span>
                                </div>
                                <h3 className="text-4xl font-extrabold mb-4 tracking-tight text-slate-900">1. Bitdefender</h3>
                                <p className="text-red-500 text-xl mb-8 font-semibold">Ironclad Defense with GravityZone</p>
                                <p className="text-slate-600 mb-10 leading-relaxed">
                                    Laptops, servers, and mobile devices are the primary entry points for attackers. We utilize Bitdefender GravityZone, a global leader in security tests, to provide your first line of defense.
                                </p>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    {[
                                        { title: "Ransomware Mitigation", desc: "Automatic detection and instant file rollback from secure cache." },
                        ...
                        <motion.div {...fadeIn} className="order-1 lg:order-2">
                            ...
                            <p className="text-slate-600 text-lg mb-8 leading-relaxed">
                                Unlike traditional antivirus that relies on outdated "signatures," Bitdefender uses advanced AI to predict and block attacks in real-time.
                            </p>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <motion.div {...fadeIn}>
                            ...
                            <p className="text-slate-600 text-lg mb-8 leading-relaxed">
                                Email is the #1 attack vector. Sorb Security provides a critical layer designed to stop sophisticated phishing attacks that human eyes often miss.
                            </p>
                            ...
                            <Card className="relative bg-slate-900 border-none rounded-[40px] overflow-hidden shadow-2xl">
                                <CardContent className="p-12">
                                    <div className="flex items-center gap-6 mb-8 border-b border-white/10 pb-8">
                                        ...
                                        <div>
                                            <h3 className="text-2xl font-bold text-white">2. Sorb Security</h3>
                                    ...
                                    <div className="space-y-8">
                                        <div>
                                            ...
                                            <p className="text-slate-400 text-sm">Detects variations like <code className="text-blue-300">c0mpany.com</code> to prevent CEO fraud and fake invoice scams.</p>
                                        </div>
                                        <div>
                                            <h4 className="text-white font-bold mb-2">GCC Threat Intelligence</h4>
                                            <p className="text-slate-400 text-sm">Tailored Specifically for threats prevalent in the Middle East and GCC region.</p>
                                        </div>
                                    </div>
                                </CardContent>
                            </Card>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <motion.div {...fadeIn} className="inline-flex items-center gap-2 px-4 py-1.5 bg-cyan-500/10 rounded-full mb-4 border border-cyan-500/20">
                            ...
                            <span className="text-[10px] font-extrabold text-cyan-400 uppercase tracking-[0.2em]">Hygiene & Compliance</span>
                        </motion.div>
                        <h2 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight">3. Vircom (modusCloud)</h2>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            { icon: Bell, title: "99.9% Spam Capture", desc: "Keeps junk mail and bulk marketing out of your inbox." },
                            { icon: Activity, title: "Email Continuity", desc: "Secure emergency portal during Microsoft 365 outages." },
                            { icon: Globe, title: "DMARC/DKIM", desc: "Brand protection against domain spoofing and fake emails." },
                            { icon: Lock, title: "DLP & Encryption", desc: "Automated encryption for sensitive financial or personal data." }
                        ].map((feature, i) => (
                            <motion.div
                                key={i}
                                initial={{ opacity: 0, y: 20 }}
                    ...
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="text-4xl font-extrabold mb-4">4. Veriato</h3>
                                <p className="text-indigo-300 font-bold text-xl mb-6 italic">Insider Risk Management</p>
                                <p className="text-indigo-100 text-lg mb-10 leading-relaxed">
                                    Sometimes the threat isn't a hacker; it's negligence or intent from within. Veriato gives you "eyes on glass" visibility.
                                </p>
                                <div className="space-y-6">
                                    {[
                                        { title: "Psycholinguistic AI", desc: "Analyze sentiment to detect disgruntled behavior before leaks." },
                                        { title: "User Behavior Analytics", desc: "Alerts for anomalies like client list downloads at 2 AM." },
                                        { title: "Forensic Screen Recording", desc: "Irrefutable evidence for security incidents or HR disputes." }
                                    ].map((item, idx) => (
                                        <div key={idx} className="flex gap-4">
                        ...
                        <motion.div {...fadeIn}>
                            ...
                            <p className="text-slate-600 text-lg mb-10 leading-relaxed">
                                Whether your team is in-office or remote, Veriato ensures your data remains protected and your workforce stays focused on high-value tasks.
                            </p>
                            <div className="p-8 bg-indigo-50 border border-indigo-100 rounded-[32px] hover:shadow-xl transition-shadow">
                                ...
                                <p className="text-slate-600 text-sm leading-relaxed">
                                    Analyze workflow patterns (Active vs. Idle time) to ensure your remote and on-site teams are performing optimally.
                                </p>
                            </div>
                        </motion.div>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <motion.div {...fadeIn} className="inline-flex items-center gap-2 px-4 py-1.5 bg-blue-600/10 rounded-full mb-4 border border-blue-600/20">
                            ...
                            <span className="text-[10px] font-extrabold text-blue-600 uppercase tracking-[0.2em]">The Human Element</span>
                        </motion.div>
                        <h2 className="text-4xl md:text-5xl font-black mb-6 tracking-tight text-slate-900">5. The Enhance Advantage: 24x7 SOC</h2>
                    ...
                    <div className="grid lg:grid-cols-3 gap-8">
                        ...
                        >
                            ...
                            <p className="text-blue-50/90 leading-relaxed">
                                Immediate action to isolate infected devices and block malicious IPs—often before you even know an attack happened.
                            </p>
                        </motion.div>
            ...
            <section className="py-24 bg-slate-900 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                    <h2 className="text-3xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-cyan-300 to-blue-500">Ready to Enhance Your Security?</h2>
