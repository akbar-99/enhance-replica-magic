                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center max-w-4xl mx-auto">
                        ...
                        >
                            ...
                            <span className="text-xs font-bold tracking-widest uppercase text-indigo-400">Enterprise Infrastructure</span>
                        </motion.div>
                        ...
                        >
                            Enhance Your Performance. Scale Your Data. Accelerate Growth. <br />
                            We build the high-performance core of your IT environment.
                        </motion.p>
                        ...
                        >
                            <Link to="/contact" className="px-8 py-4 bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-2xl transition-all shadow-lg shadow-indigo-500/25 flex items-center gap-2 group">
                                Get a Server Quote
