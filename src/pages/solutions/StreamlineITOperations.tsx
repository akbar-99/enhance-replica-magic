import { ArrowRight, CheckCircle2, Shield, Zap, Lock, Eye, Database, Server, Cloud, HardDrive, Activity, Globe, FileText, Search, Users, AlertTriangle, RefreshCw, ShieldCheck, Box, BarChart3, Workflow, Briefcase, Cpu, Headphones, Layers, Network } from "lucide-react";
    ...
    return (
        <main className="min-h-screen page-bg-light overflow-x-hidden relative">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                        <div className="flex-1 text-center lg:text-left">
                            <motion.div {...fadeIn} className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-md rounded-full mb-6 border border-white/20">
                                ...
                                <span className="text-sm font-semibold text-cyan-100 uppercase tracking-wider">Operational Maturity</span>
                            </motion.div>
                            <motion.h1
                                {...fadeIn}
                            ...
                            >
                                Enhance Your Operational Maturity. <span className="text-white font-bold">Unify Service, Assets, and Projects</span> in one seamless platform.
                            </motion.p>
                            <motion.div
                                {...fadeIn}
                            ...
                            >
                                <Link to="/demo">
                                    <Button size="lg" className="bg-cyan-600 hover:bg-cyan-500 text-white shadow-[0_0_30px_-5px_rgba(8,145,178,0.4)] rounded-full px-12 h-20 text-xl font-black transition-all hover:scale-105 active:scale-95 group">
                                        Book a Live Demo
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <motion.div {...fadeIn}>
                            ...
                            <div className="space-y-6 text-slate-600 leading-relaxed text-lg">
                                ...
                                <p>
                                    In a complex digital environment, "IT Support" is just one piece of the puzzle. If your teams are juggling disparate tools for ticketing, inventory, and projects, operational drag is inevitable.
                                </p>
                                <p>
                                    At Enhance Tech, we help you move from reactive support to proactive operations. We implement unified IT Operations Management (ITOM) and Service Management (ITSM) platforms that act as the central nervous system for your technology department.
                                </p>
                            </div>
                        </motion.div>
                        <motion.div
            ...
            <section className="py-24 bg-slate-50 relative">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <motion.h2 {...fadeIn} className="text-3xl md:text-4xl font-bold mb-4 tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-cyan-500 to-blue-600">Why Streamline Operations?</motion.h2>
                    ...
                    >
                        {[
                            { icon: Eye, title: "Unified Visibility", desc: "Eliminate 'swivel-chair' effect. Centralize tickets, projects, and assets in one pane of glass." },
                            { icon: HardDrive, title: "Total Asset Lifecycle", desc: "Track every hardware, software, and contract from procurement to disposal." },
                            { icon: Workflow, title: "Automated Workflows", desc: "Standardize onboarding, approvals, and patching. Reduce overhead by 40%." },
                            { icon: ShieldCheck, title: "Seamless Service Delivery (ITIL)", desc: "Align with best practices. Standardize Incidents, Changes, and Problems." },
                            { icon: BarChart3, title: "Data-Driven Strategy", desc: "Track SLA performance, utilization, and budget with visual dashboards." },
                        ].map((benefit, i) => (
                            <motion.div
                                key={i}
                                variants={fadeIn}
                            ...
                            >
                                ...
                                <div className="relative z-10">
                                    ...
                                    <h3 className="text-2xl font-black text-slate-900 mb-6 group-hover:text-cyan-600 transition-colors tracking-tight leading-tight">{benefit.title}</h3>
            ...
            <section className="py-24 bg-white relative">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-16">
                        <motion.h2 {...fadeIn} className="text-3xl md:text-5xl font-bold mb-6 tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-cyan-500 to-blue-600">
                            What's Included
                        </motion.h2>
            ...
            <section className="py-24 bg-slate-950 text-white overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-20">
                        <motion.h2 {...fadeIn} className="text-3xl md:text-5xl font-bold mb-4 tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-blue-500">Our Technology Ecosystem</motion.h2>
                            ...
                            >
                                ...
                                >
                                    <div className="relative z-10">
                                        ...
                                        <h3 className="text-4xl font-extrabold mb-4 tracking-tight text-white group-hover:text-cyan-400 transition-colors">1. Freshworks (Freshservice)</h3>
                                        <p className="text-cyan-400/90 text-lg mb-8 font-medium italic">"The AI-Powered, User-First Platform"</p>
                                        <p className="text-slate-300 mb-10 leading-relaxed text-sm">
                                            Freshworks redefines IT operations with an interface that requires minimal training. It combines powerful ITOM capabilities with a user experience that employees actually enjoy.
                                        </p>
                                        <div className="space-y-6">
                                            {[
                                                { title: "Core Strengths", desc: "Rapid deployment and high adoption rates due to consumer-grade design." },
                                                { title: "AI Operations", desc: "'Freddy AI' auto-suggests fixes and analyzes trends to predict incidents." },
                                                { title: "Orchestration", desc: "Connects with Azure/AWS to automate actions like restarting servers." }
                                            ].map((item, idx) => (
                                ...
                                >
                                    <div className="relative z-10">
                                        <div className="px-4 py-1.5 bg-blue-500/20 border border-blue-500/30 rounded-full inline-block mb-6">
                                            <span className="text-blue-400 font-bold tracking-[0.3em] uppercase text-[10px]">All-Inclusive Platform</span>
                                        </div>
                                        <h3 className="text-4xl font-extrabold mb-4 tracking-tight text-white group-hover:text-blue-400 transition-colors">2. Halo ITSM</h3>
                                        <p className="text-blue-400/90 text-lg mb-8 font-medium italic">"The All-Inclusive Operations Platform"</p>
                                        <p className="text-slate-300 mb-10 leading-relaxed text-sm">
                                            Halo ITSM is a powerhouse for organizations that want everything in one place. It eliminates the need for separate Project Management or Asset tools.
                                        </p>
                                        <div className="space-y-6">
                                            {[
                                                { title: "Core Strengths", desc: "Deep customization and an all-inclusive model (Projects, Assets, and Service Desk)." },
                                                { title: "Advanced Workflow Engine", desc: "Digitize complex approval hierarchies and operational processes." },
                                                { title: "Integrations", desc: "Central hub for all your IT tools (RMM, ERP, Cloud) via native connectors." }
                                            ].map((item, idx) => (
                    ...
                    <div className="flex flex-col lg:flex-row gap-20 items-center">
                        <div className="lg:w-1/3">
                            <motion.div {...fadeIn} className="inline-flex items-center gap-2 px-4 py-1.5 bg-blue-100 rounded-full mb-6 border border-blue-200">
                                ...
                                <span className="text-[10px] font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-cyan-500 to-blue-600 uppercase tracking-[0.3em]">The Enhance Advantage</span>
                            </motion.div>
                            <motion.h2 {...fadeIn} className="text-3xl md:text-5xl font-extrabold mb-8 leading-tight tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-cyan-500 to-blue-600">
                                We Don't Just Implement Software. <br /> We Build Process.
                            </motion.h2>
                            <motion.p {...fadeIn} className="text-slate-600 text-lg leading-relaxed">
                                A tool is only as good as the process it supports. Dropping a new software into a chaotic environment just digitizes the chaos.
                            </motion.p>
                        </div>

                        <div className="lg:w-2/3 grid md:grid-cols-3 gap-8">
                            {[
                                { title: "Process Engineering", desc: "We 'enhance' workflows to align with ITIL best practices before configuration.", icon: Layers },
                                { title: "Adoption Strategy", desc: "We train your agents and end-users to ensure the system is used effectively.", icon: Users },
                                { title: "Ecosystem Integration", desc: "We connect Operations with Security and Backup for a seamless data flow.", icon: Network }
                            ].map((item, i) => (
                                <motion.div
                                    key={i}
                                    initial={{ opacity: 0, y: 20 }}
                                ...
                                >
                                    ...
                                    <h3 className="text-xl font-bold mb-4 group-hover:text-cyan-600 transition-colors uppercase tracking-tight">{item.title}</h3>
            ...
            <section className="py-24 bg-slate-900 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                    <h2 className="text-3xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-blue-500">Transform Your IT Operations Today</h2>
