...
export default function StreamlineITOperations() {
    // Structured data for IT operations management
    const serviceSchema = createServiceSchema(
        "IT Operations Management Solutions",
        "Streamline your IT operations with Freshworks and Halo ITSM. Advanced service desk, asset management, and IT automation solutions. Optimize efficiency and reduce response times in Dubai, UAE."
    );

    const breadcrumbSchema = createBreadcrumbSchema([
        { name: "Home", url: "https://itenhance.tech" },
        { name: "Solutions", url: "https://itenhance.tech/solutions" },
        { name: "Streamline IT Operations", url: "https://itenhance.tech/solutions/streamline-it-operations" }
    ]);
    ...
    const structuredData = {
        ...
        "@graph": [
            ...
            breadcrumbSchema,
            {
                ...
                "description": "Professional ITSM solutions with Freshworks and Halo PSA for comprehensive IT operations management",
                "offers": {
                    "@type": "Offer",
    ...
    return <main className="min-h-screen page-bg-light overflow-x-hidden relative">
        <SEO
            title="Streamline IT Operations: Service Desk & ITSM | Enhance Tech"
            description="Optimize your IT operations with Freshworks and Halo ITSM. Modern service desk, asset management, and automation solutions for efficient IT management in Dubai, UAE."
            keywords="IT Operations, ITSM, Service Desk, Freshworks, Halo PSA, IT Automation, Asset Management Dubai"
                    ...
                    <div className="flex-1 text-center lg:text-left">
                        ...
                        >
                            <Link to="/demo">
                                <Button
                                    size="lg"
                                    className="bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white shadow-lg shadow-cyan-500/30 rounded-full px-8 h-14 text-base font-semibold transition-all hover:scale-105 active:scale-95 group"
                                >
                                    Book a Live Demo
                            ...
                            <Link to="/contact">
                                <Button
                                    size="lg"
                                    variant="outline"
                                    className="border-white/40 text-white hover:bg-gradient-to-r hover:from-white/10 hover:to-white/5 backdrop-blur-md rounded-full px-8 h-14 text-base font-semibold transition-all border-2 hover:border-white/60"
                                >
                                    Contact Our Team
                                </Button>
                            </Link>
        ...
        <section className="py-24 bg-slate-900 relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Link to="/demo">
                        <Button size="lg" className="bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white rounded-full px-8 h-14 text-base font-semibold shadow-lg shadow-cyan-500/30 transition-all hover:scale-105">
                            Book a Live Demo
                    ...
                    <Link to="/contact">
                        <Button
                            size="lg"
                            variant="outline"
                            className="border-slate-600 text-white rounded-full px-8 h-14 text-base font-semibold hover:bg-gradient-to-r hover:from-slate-800 hover:to-slate-700 transition-all hover:border-slate-500"
                        >
                            Contact Our Team
                        </Button>
                    </Link>
