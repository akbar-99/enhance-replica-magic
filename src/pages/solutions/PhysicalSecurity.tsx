                ...
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                    <div className="flex-1 text-center lg:text-left">
                        ...
                        <motion.div {...fadeIn} transition={{
                            ...
                            <Link to="/contact">
                                <Button size="lg" className="bg-gradient-to-r from-orange-500 to-orange-700 hover:from-orange-400 hover:to-orange-600 text-white shadow-xl shadow-orange-500/25 rounded-2xl px-10 h-14 text-base font-bold transition-all hover:scale-105 active:scale-95 border-none">
                                    Book a Site Survey
