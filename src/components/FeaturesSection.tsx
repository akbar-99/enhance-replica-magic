  ...
  return <section className="bg-white py-[35px]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-500 max-w-2xl mx-auto leading-relaxed px-[180px]">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => <Link key={feature.title} to={feature.link} className="group relative" style={{
          animationDelay: `${index * 100}ms`
              ...
              <div className={`relative bg-white rounded-3xl p-6 h-full transition-all duration-300 group-hover:shadow-2xl ${cardColors[index].glow}`}>
                ...
                <div className={`w-full h-48 rounded-2xl bg-gradient-to-br ${cardColors[index].bg} flex items-center justify-center mb-5 group-hover:scale-[1.03] transition-all duration-500 overflow-hidden border-2 border-transparent group-hover:border-primary/20`}>
                  <img src={feature.image} alt={feature.title} className="w-full h-full object-contain p-3 animate-float group-hover:scale-110 transition-transform duration-500" style={{
