          ...
          <div className="w-full bg-white rounded-lg shadow-sm border border-[hsl(220,20%,92%)] p-3">
            ...
            <div className="flex gap-4 mb-3">
              <div className="flex-1">
                <p className="text-[9px] font-bold text-[hsl(215,30%,25%)] uppercase tracking-wider">% Sensitive Files</p>
                <p className="text-[7px] text-[hsl(215,20%,55%)]">PII, PCI, PHI as % of total scanned</p>
              </div>
              <div className="flex-1">
                <p className="text-[9px] font-bold text-[hsl(215,30%,25%)] uppercase tracking-wider">Access Level Breakdown</p>
                <p className="text-[7px] text-[hsl(215,20%,55%)]">Exposure types detected</p>
              </div>
              <div className="w-14">
                <p className="text-[9px] font-bold text-[hsl(215,30%,25%)] uppercase tracking-wider text-right">Volume</p>
              </div>
            </div>
