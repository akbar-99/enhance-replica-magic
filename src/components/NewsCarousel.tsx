...
export default function NewsCarousel() {
  ...
  return (
    <section className="relative bg-gradient-to-r from-primary/20 via-primary/10 to-glow-cyan/20 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-6">
          {/* Previous Button */}
          <button
            onClick={prevSlide}
            className="flex-shrink-0 w-10 h-10 rounded-full border border-foreground/20 flex items-center justify-center text-foreground/60 hover:text-foreground hover:border-foreground/40 transition-colors"
          >
          ...
          <div className="flex-1 text-center space-y-4" key={currentItem.id}>
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              {currentItem.secondaryCta && currentItem.secondaryLink && (
                <Link
                  to={currentItem.secondaryLink}
                  className="inline-flex items-center gap-2 text-foreground/80 hover:text-foreground font-medium transition-colors"
                >
