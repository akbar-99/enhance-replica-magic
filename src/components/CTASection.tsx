  ...
  return <section className="relative overflow-hidden py-16 bg-gradient-to-r from-cyan-500 to-blue-600">
    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      ...
      <motion.div initial={{
        ...
        {/* Card content */}
        <div className="relative bg-black backdrop-blur-xl rounded-3xl border border-white/10 px-8 text-center overflow-hidden md:px-16 py-12 group-hover:border-white/20 transition-colors duration-500 shadow-none">
