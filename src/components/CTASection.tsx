...
const FloatingParticle = ({
  ...
  <motion.div
    className="absolute rounded-full bg-glow-cyan/20"
    style={{
      width: size,
      height: size,
      left,
    ...
    >
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <motion.div
            className="absolute -top-2 -left-2 w-32 h-32 bg-glow-cyan/60 rounded-full blur-2xl"
            animate={{
              opacity: [0.4, 0.7, 0.4],
              scale: [1, 1.2, 1],
            }}
          ...
          />
          <motion.div
            className="absolute -bottom-2 -right-2 w-32 h-32 bg-glow-cyan/60 rounded-full blur-2xl"
            animate={{
              opacity: [0.4, 0.7, 0.4],
              scale: [1, 1.2, 1],
            }}
          ...
          />
          <motion.div
            className="absolute top-1/2 -right-4 w-24 h-48 bg-glow-cyan/30 rounded-full blur-3xl -translate-y-1/2"
            animate={{
              opacity: [0.2, 0.5, 0.2],
              x: [10, -10, 10],
            }}
          ...
          {/* Card content */}
          <div className="relative bg-gradient-to-r from-cyan-500 to-blue-600 relative overflow-hidden">
            ...
            />
            <motion.div
              className="absolute top-0 right-1/3 w-px h-full bg-gradient-to-b from-transparent via-glow-cyan/20 to-transparent"
              animate={{
                opacity: [0, 0.5, 0],
                y: [100, -100, 100],
              }}
            ...
            />
            <motion.div
              className="absolute w-2 h-2 bg-glow-cyan/40 rounded-full blur-sm"
              style={{
                right: "25%",
                bottom: "25%",
              }}
