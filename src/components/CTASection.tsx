...
export default function CTASection() {
  ...
  return <section className="relative overflow-hidden py-[35px] bg-white">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        duration: 0.6
          ...
          {/* Card content */}
          <div className="relative bg-card backdrop-blur-sm rounded-3xl border border-border/40 px-8 text-center overflow-hidden md:px-[63px] py-[35px]">
            ...
            <div className="absolute inset-0 pointer-events-none opacity-50">
              ...
              <motion.div className="absolute w-3 h-3 bg-primary/30 rounded-full" style={{
              right: '20%',
              top: '35%'
            }} animate={{
              y: [10, -10, 10],
              ...
              <motion.div className="absolute w-2 h-2 bg-glow-cyan/30 rounded-full" style={{
              right: '15%',
              bottom: '30%'
            }} animate={{
              x: [-10, 10, -10],
            ...
            delay: 0.4
              ...
              <Link to="/contact" className="inline-flex items-center gap-2 bg-primary hover:bg-primary/90 text-primary-foreground font-semibold px-8 py-4 rounded-full transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_hsl(var(--primary)/0.5)] group/btn">
                Talk to an Expert
