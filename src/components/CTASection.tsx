    ...
    backgroundPosition: 'center'
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        duration: 0.6
          ...
          {/* Card content */}
          <div className="relative backdrop-blur-xl rounded-3xl border border-white/10 px-8 text-center overflow-hidden md:px-16 py-12 group-hover:border-white/20 transition-colors duration-500 bg-[#0f0f0f]/0">
