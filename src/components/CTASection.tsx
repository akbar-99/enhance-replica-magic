...
export default function CTASection() {
  const particles = [
    ...
    { delay: 0.5, duration: 5, size: 8, left: '20%', top: '70%' },
    { delay: 1, duration: 4.5, size: 4, left: '80%', top: '30%' },
    { delay: 1.5, duration: 5.5, size: 10, left: '85%', top: '60%' },
    { delay: 2, duration: 4, size: 5, left: '15%', top: '40%' },
    { delay: 0.8, duration: 6, size: 7, left: '70%', top: '80%' },
    { delay: 1.2, duration: 5, size: 6, left: '50%', top: '15%' },
    { delay: 2.5, duration: 4.5, size: 8, left: '30%', top: '85%' },
    { delay: 0.3, duration: 5.5, size: 5, left: '90%', top: '45%' },
    { delay: 1.8, duration: 4, size: 4, left: '5%', top: '55%' },
  ];
    ...
    <section className="py-24 bg-background relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          {/* Card content */}
          <div className="relative bg-card backdrop-blur-sm rounded-3xl border border-border/40 py-16 px-8 md:px-16 text-center overflow-hidden">
