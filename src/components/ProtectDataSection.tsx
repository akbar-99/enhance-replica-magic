      ...
      <div className="grid lg:grid-cols-2 gap-0 rounded-3xl overflow-hidden shadow-2xl border border-border/20">
        ...
        <div className="relative bg-hero-gradient p-10 lg:p-14 flex items-center min-h-[420px] mx-0">
          ...
          <div className="relative z-10">
            <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold leading-tight tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-cyan-300 to-blue-500">
              Secure Your Data, <br />
              Secure Your Future.
            </h2>
          </div>
